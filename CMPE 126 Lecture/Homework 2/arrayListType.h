...
template <class Type> void arrayListType<Type>::print(){
    int count = 1;
...
template <class Type> void arrayListType<Type>::insertAt(int location, const Type& insertItem){
...
template <class Type> void arrayListType<Type>::insertEnd(const Type& insertItem){
...
template <class Type> void arrayListType<Type>::removeAt(int location){
...
template <class Type>void arrayListType<Type>::retrieveAt(int location, Type& retItem) const{
    if (location < 0 || location >= length)
...
template <class Type> void arrayListType<Type>::replaceAt(int location, const Type& repItem){
    if (location < 0 || location >= length)
...
template <class Type> int arrayListType<Type>::seqSearch(const Type& item) const{
    int loc;
    bool found = false;
...
template <class Type>void arrayListType<Type>::insert(const Type& insertItem){
    int loc;
...
template<class Type> void arrayListType<Type>::remove(const Type& removeItem){
    int loc;
...
template <class Type>arrayListType<Type>::arrayListType(int size){
    if (size < 0)
    {
